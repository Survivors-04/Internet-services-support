...
export class createTables1667606361395 implements MigrationInterface {
    name = 'createTables1667606361395'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "attendance" ("id" uuid NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT now(), "is_active" boolean NOT NULL DEFAULT true, "serviceId" uuid, "clientId" uuid, "collaboratorId" uuid, CONSTRAINT "REL_7aab7e3b32e3985cc4c74f78a6" UNIQUE ("serviceId"), CONSTRAINT "PK_ee0ffe42c1f1a01e72b725c0cb2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "attendance" ADD CONSTRAINT "FK_7aab7e3b32e3985cc4c74f78a69" FOREIGN KEY ("serviceId") REFERENCES "services"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
