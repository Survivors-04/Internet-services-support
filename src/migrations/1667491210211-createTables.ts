...
export class createTables1667491210211 implements MigrationInterface {
    name = 'createTables1667491210211'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "attendance" ("id" uuid NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT now(), "is_active" boolean NOT NULL DEFAULT true, "addressId" uuid, "clientId" uuid, "collaboratorId" uuid, CONSTRAINT "REL_7aab7e3b32e3985cc4c74f78a6" UNIQUE ("addressId"), CONSTRAINT "PK_ee0ffe42c1f1a01e72b725c0cb2" PRIMARY KEY ("id"))`);
