...
export class alterationTable1667317879770 implements MigrationInterface {
    name = 'alterationTable1667317879770'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Client" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(120) NOT NULL, "cpf" character varying(120) NOT NULL, "telephone" integer NOT NULL, "email" character varying(100) NOT NULL, "password" character varying(120) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "created_date" TIMESTAMP NOT NULL DEFAULT now(), "updated_date" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b79874c8d411b839b9ccc301972" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "attendance" ("id" uuid NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean NOT NULL DEFAULT true, "addressId" uuid, "clientId" uuid, "collaboratorId" uuid, CONSTRAINT "REL_7aab7e3b32e3985cc4c74f78a6" UNIQUE ("addressId"), CONSTRAINT "PK_ee0ffe42c1f1a01e72b725c0cb2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "supervisor" ("id" uuid NOT NULL, "name" character varying NOT NULL, "cpf" character varying(120) NOT NULL, "telephone" integer NOT NULL, "email" character varying(100) NOT NULL, "is_manager" boolean NOT NULL, "password" character varying(120) NOT NULL, CONSTRAINT "PK_6364b1ffaa6ca051de919c802ed" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "collaborator" ("id" uuid NOT NULL, "name" character varying NOT NULL, "cpf" integer NOT NULL, "telephone" integer NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "teamId" uuid, CONSTRAINT "PK_aa48142926d7bdb485d21ad2696" PRIMARY KEY ("id"))`);
